...
namespace IM3_Plugin3
{
    ...
    public partial class FormForControl : Form
    {
        ...
        public List<cBiological3DObject> AssociatedBiologicalObjectList = new List<cBiological3DObject>();
        public IM3_Plugin3 Parent;
        ...
        private void BuilEmptyControl(IM3_Plugin3 Parent)
        {
            InitializeComponent();
            this.Parent = Parent;
        ...
        public FormForControl(IM3_Plugin3 Parent, cListCtrls NewListCtrls)
        {
        ...
        public FormForControl(IM3_Plugin3 Parent, cPoint3D ThumbnailPos)
        {
            BuilEmptyControl(Parent);
