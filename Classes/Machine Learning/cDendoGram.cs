...
namespace HCSAnalyzer.Classes
{
    ...
    {    
        ...
        { 
            ...
            this.InfoForHierarchical.UpDateMinMaxDescByDesc();
            RunClustering();
        }


        public cDendoGram(cGlobalInfo GlobalInfo, bool IsFullScreen, int NumClusters)
        {
            this.GlobalInfo = GlobalInfo;
            this.NumClusters = NumClusters;
            ...
            if (IsFullScreen)
                this.InfoForHierarchical = cGlobalInfo.CurrentScreening.CreateInstancesWithUniqueClasse();
            else
                this.InfoForHierarchical = cGlobalInfo.CurrentScreening.GetCurrentDisplayPlate().CreateInstancesWithUniqueClasse();

            this.InfoForHierarchical.UpDateMinMax(cGlobalInfo.CurrentScreening);
        ...
        void RunClustering()
        {
            ...
            if (this.InfoForHierarchical.ListInstances.numInstances() < 2)
            {
                MessageBox.Show("You need at least 2 instances to perform this clustering", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public cDendoGram(HierarchicalClusterer GeneratedHierarchicalClusterer, cInfoForHierarchical InfoHierachical, cGlobalInfo GlobalInfo)
        {
            this.GlobalInfo = GlobalInfo;
            ...
            this.InfoForHierarchical.UpDateMinMaxGlobal(-1, 1);
            //this.InfoForHierarchical.UpDateMinMax(cGlobalInfo.CurrentScreening);
        ...
        public class Node
        {
            ...
            public weka.core.Instance AssociatedInstance = null;
                ...
                if (Node2 == null)
                {
                    ...
                    if (Name.IndexOf("Input") == -1)
                    {
                        if (OurDendo.InfoForHierarchical!=null)
                        {
                            ...
                            {
                                int ValPos = (int)(double.Parse(Name));
                                Node2.AssociatedWell = OurDendo.InfoForHierarchical.ListIndexedWells[ValPos];
                                Node2.AssociatedInstance = OurDendo.InfoForHierarchical.ListInstances.instance(ValPos);
                            }
                            else
                            {
                                int ValPos = (int)(double.Parse(Name));
        ...
        private void GenerateDendogram(string ToProcess, string LinkType, string Distance)
        {
            ...
            FormDendogram DendogramDisplay = new FormDendogram(this.GlobalInfo);
