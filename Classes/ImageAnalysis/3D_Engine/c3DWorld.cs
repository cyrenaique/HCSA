...
//reslice1.Update();
   ...
   * */
        ...
        void OptionsItem(object sender, EventArgs e)
        {
            ...
            cGlobalInfo.OptionsWindow.tabControlWindowOption.SelectedTab = cGlobalInfo.OptionsWindow.tabPage3D;

            //cGlobalInfo.OptionsWindow.CurrentScreen = this.CurrentScreen;
